...
关于一些细节实现和用法，可以参考一些我们推荐的模型，例如:[Resnet](https://gitee.com/mindspore/models/tree/r1.9/official/cv/resnet), [Yolov5](https://gitee.com/mindspore/models/tree/r1.9/official/cv/yolov5), [IPT](https://gitee.com/mindspore/models/tree/r1.9/research/cv/IPT), [Transformer](https://gitee.com/mindspore/models/tree/r1.9/official/nlp/transformer), etc.
