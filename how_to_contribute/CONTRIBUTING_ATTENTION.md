...
For some details of implementations, you could refer to some recommended models such as [Resnet](https://gitee.com/mindspore/models/tree/r1.8/official/cv/resnet), [Yolov5](https://gitee.com/mindspore/models/tree/r1.8/official/cv/yolov5), [IPT](https://gitee.com/mindspore/models/tree/r1.8/research/cv/IPT), [Transformer](https://gitee.com/mindspore/models/tree/r1.8/official/nlp/transformer), etc.
