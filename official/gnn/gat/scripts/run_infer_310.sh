...
function cal_acc()
{
    python ../postprocess.py --result_path=./result_Files --dataset_name=$dataset_name --label_path=./preprocess_Result/y_test.npy --mask_path=./preprocess_Result/test_mask.npy &> acc.log
}
