...
def run_eval():
    ...
    de_dataset, _ = SintelTraining(cfg.eval_dir, cfg.valid_augmentations, 'final', 'valid', cfg.val_batch_size,
    ...
    if os.path.isfile(cfg.pretrained):
        ...
        for key, values in param_dict.items():
            if key.startswith('moment1.' or 'moment2' or 'global_step' or 'beta1_power' or
                              'beta2_power' or 'learning_rate'):
                continue
