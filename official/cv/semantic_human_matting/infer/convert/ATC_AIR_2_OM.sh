...
input_shape="x:1,3,320,320"
# help message
if [[ $1 == --help || $1 == -h ]];then
    echo"usage:bash ./ATC_AIR_2_OM.sh <args>"
    echo "parameter explain:
    --model                  set model place, e.g. --model=/home/HwHiAiUser/data/model/shm_export.air
    --output                 set the name and place of OM model, e.g. --output=/home/HwHiAiUser/data/model/shm_export
    --soc_version            set the soc_version, default: --soc_version=Ascend310
    --input_shape            set the input node and shape, default: --input_shape='x:1,3,320,320'
