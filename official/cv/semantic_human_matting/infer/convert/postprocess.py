...
def get_args():
    ...
    python postprocess.py
        --result_path=../sdk/results/result_Files
        --pre_path=../sdk/results/preprocess_Result
        --save_path=../data/sdk_result/postprocess_Result
    """
    parser = argparse.ArgumentParser(description='Semantic human matting')
    parser.add_argument(
        '--result_path',
        type=str,
        default='../data/sdk_result/result_Files',
        help='infer path')
    parser.add_argument(
        '--pre_path',
        type=str,
        default='../data/sdk_result/scripts/preprocess_Result',
        help='pre path')
    parser.add_argument(
        '--save_path',
        type=str,
        default='../data/sdk_result/scripts/postprocess_Result',
        help='save path')
