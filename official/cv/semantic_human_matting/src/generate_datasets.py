...
class GenerateData:
    ...
    def generate_mean_std(self):
        ...
        if self.cfg['generate_mean_std']:
            ...
            print('mean_clip: ', [float('{:.5f}'.format(x / n / 255)) for x in mean_clip],
                  [int(x / n) for x in mean_clip])
            print('std_clip: ', [float('{:.5f}'.format(x / n / 255)) for x in std_clip],
                  [int(x / n) for x in std_clip])
            print('mean_trimap: ', [float('{:.5f}'.format(x / n / 255)) for x in mean_trimap],
                  [int(x / n) for x in mean_trimap])
            print('std_trimap: ', [float('{:.5f}'.format(x / n / 255)) for x in std_trimap],
