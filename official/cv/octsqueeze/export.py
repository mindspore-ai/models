...
parser.add_argument(
    '--batch_size', type=int, default=98304, help='batch size of data')
parser.add_argument(
    '--file_name', '-n', type=str, default='octsqueeze', help='name of model')
parser.add_argument(
    '--file_format', '-f', type=str, default='MINDIR', help='format of model')
parser.add_argument('--device_target', type=str, default="Ascend",
                    choices=['Ascend', 'GPU', 'CPU'], help='device where the code will be implemented')
parser.add_argument(
    '--device_id', type=int, default=0, help='which device where the code will be implemented')
