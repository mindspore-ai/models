...
parser.add_argument('--data_url', '-f', type=str, default='/home/OctSqueeze/feature/KITTI_1000/',
                    help='folder of training data')
parser.add_argument('--max_epochs', '-e', type=int, default=200, help='max epochs')
parser.add_argument('--device_target', type=str, default="Ascend", choices=['Ascend', 'GPU', 'CPU'],
                    help='device where the code will be implemented')
parser.add_argument('--train_url', '-c', type=str, default='/home/OctSqueeze/ckpt/',
                    help='folder of checkpoint and path')
# For Parallel
...
def network_init(argvs):
    ...
    context.set_context(mode=context.GRAPH_MODE, enable_auto_mixed_precision=True,
                        device_target=argvs.device_target, save_graphs=False, device_id=devid)
    # Init distributed
...
if __name__ == '__main__':
    ...
    if args.is_distributed == 1:
        ...
        dataset = ds.GeneratorDataset(data_generator, ['feature', 'label'], shuffle=False,
