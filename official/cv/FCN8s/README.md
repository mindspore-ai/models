...
- running on Ascend with default parameters
  ...
  分布式训练需要提前创建JSON格式的HCCL配置文件,请遵循[链接说明](https://gitee.com/mindspore/models/tree/r1.9/utils/hccl_tools)
...
| Scripts                    | [FCN script](https://gitee.com/mindspore/models/tree/r1.9/official/cv/FCN8s)
...
如果你需要在不同硬件平台（如GPU，Ascend 910 或者 Ascend 310）使用训练好的模型，你可以参考这个 [Link](https://www.mindspore.cn/tutorials/experts/zh-CN/r1.9/infer/inference.html)。以下是一个简单例子的步骤介绍：
