...
int main(int argc, char* argv[]) {
    if (argc <= 1) {
        LogWarn << "Please input image path, such as './resnext101 image_dir'.";
        return APP_ERR_OK;
    }
    ...
    initParam.labelPath = "../python/models/imagenet1000_clsidx_to_labels.names";
    initParam.topk = 5;
    initParam.softmax = false;
    initParam.checkTensor = true;
    initParam.modelPath = "../python/models/resnext101_r.om";
