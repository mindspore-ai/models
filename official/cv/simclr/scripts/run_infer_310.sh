...
function preprocess_data()
{
    ...
    python ../preprocess.py --eval_dataset_path=$data_path --result_path=./preprocess_Result/
}
...
function cal_acc()
{
    python ../postprocess.py --result_dir=./result_Files --label_dir=./preprocess_Result/label_ids.npy &> acc.log
}
