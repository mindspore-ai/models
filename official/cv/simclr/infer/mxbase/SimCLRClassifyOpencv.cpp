...
#include "SimCLRClassifyOpencv.h"
...
APP_ERROR SimCLRClassifyOpencv::Init(const InitParam &initParam) {
...
APP_ERROR SimCLRClassifyOpencv::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR SimCLRClassifyOpencv::ConvertImageToTensorBase(const std::string &imgPath,
...
APP_ERROR SimCLRClassifyOpencv::Inference(std::vector<TensorBase> &inputs,
...
APP_ERROR SimCLRClassifyOpencv::PostProcess(std::vector<TensorBase> &inputs,
...
APP_ERROR SimCLRClassifyOpencv::SaveResult(const std::string &imgPath,
...
APP_ERROR SimCLRClassifyOpencv::Process(const std::string &imgPath) {
    TensorBase tensorBase;
