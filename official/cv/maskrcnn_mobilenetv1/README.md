...
> hccl.json which is specified by RANK_TABLE_FILE is needed when you are running a distribute task. You can generate it by using the [hccl_tools](https://gitee.com/mindspore/models/tree/r1.9/utils/hccl_tools).
...
| Scripts                    | [maskrcnn script](https://gitee.com/mindspore/models/tree/r1.9/official/cv/maskrcnn_mobilenetv1) |  [maskrcnn script](https://gitee.com/mindspore/models/tree/r1.9/official/cv/maskrcnn_mobilenetv1) |
