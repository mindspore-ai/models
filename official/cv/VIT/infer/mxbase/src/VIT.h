...
class VIT {
 public:
  ...
  APP_ERROR DeInit();
  void read_image(const std::string &imgPath, cv::Mat *imageMat);
  void resize_image(const cv::Mat &srcImageMat, cv::Mat *dstImageMat);
  void crop_image(const cv::Mat &srcImageMat, cv::Mat &dstImageMat);
