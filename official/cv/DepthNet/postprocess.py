...
def cal_acc_nyu(result_path, label_path):
    ...
    print("delta1_loss: ", delta1_ave, " delta2_loss: ", delta2_ave, " delta3_loss: ", delta3_ave,
          " abs_relative_loss: ", abs_relative_ave, " sqr_relative_loss: ", sqr_relative_ave,
          " rmse_linear_loss: ", rmse_linear_ave, " rmse_log_loss: ", rmse_log_ave)
