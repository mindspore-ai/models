...
if __name__ == "__main__":
    ...
    ds_train = create_dataset(os.path.join(args.data_url, "train"), cfg.batch_size, 1)
    ...
    ckpt_callback = ModelCheckpoint(prefix="checkpoint_lenet", config=config_ckpt, directory=args.train_url)
    ...
    export(network, inputs, file_name=os.path.join(args.train_url + "/lenet_quant"), file_format="AIR",
           quant_mode='QUANT')
