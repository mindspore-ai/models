...
def parse_args(parsers):
    ...
    parsers.add_argument('--images_txt_path', type=str,
                         default="../data/lenet_quant_mnist_310_infer_data/mnist_bs_1_label.txt",
                         help='image text')
    return parsers
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Om lenet quant Inference')
    ...
    with open("../data/config/lenet_quant.pipeline", 'rb') as f:
        pipeline = f.read()
    ...
    for idx, file in enumerate(file_list):
        ...
        unique_id = stream_manager.SendProtobuf(b'lenet_quant', b'appsrc0', protobufVec1)

        # Obtain the inference result by specifying streamName and uniqueId.
        infer_result = stream_manager.GetResult(b'lenet_quant', 0)
