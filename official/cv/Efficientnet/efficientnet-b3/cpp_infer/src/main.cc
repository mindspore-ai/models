...
int main(int argc, char **argv) {
  ...
  std::shared_ptr<TensorTransform> resize = std::make_shared<Resize>(std::vector<int>{320});
  std::shared_ptr<TensorTransform> centercrop = std::make_shared<CenterCrop>(std::vector<int>{300});
