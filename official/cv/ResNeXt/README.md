...
`MODEL_DEVICE_TYPE` specifies device target of MindIR, should be in ['Ascend', 'GPU'].
`INFER_DEVICE_TYPE` specifies device target to run inference, should be in ['Ascend', 'GPU', 'CPU'].
