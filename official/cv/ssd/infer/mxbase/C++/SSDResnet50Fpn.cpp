...
APP_ERROR SSDResnet50Fpn::Init(const InitParam &initParam) {
...
APP_ERROR SSDResnet50Fpn::DeInit() {
    dvppWrapper_->DeInit();
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR SSDResnet50Fpn::ReadImage(const std::string &imgPath, MxBase::TensorBase &tensor) {
...
APP_ERROR SSDResnet50Fpn::Resize(const MxBase::TensorBase &inputTensor, MxBase::TensorBase &outputTensor) {
...
APP_ERROR SSDResnet50Fpn::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR SSDResnet50Fpn::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
