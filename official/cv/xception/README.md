...
> Notes: RANK_TABLE_FILE can refer to [Link](https://www.mindspore.cn/docs/programming_guide/en/master/distributed_training_ascend.html), and the device_ip can be got as [Link](https://gitee.com/mindspore/models/tree/r1.5/utils/hccl_tools).
...
| Params (M)                 | 180M                      | 180M                      |
| Scripts                    | [Xception script](https://gitee.com/mindspore/models/tree/r1.5/official/cv/xception) | [Xception script](https://gitee.com/mindspore/models/tree/r1.5/official/cv/xception) |
