...
APP_ERROR Xception::Init(const InitParam &initParam) {
...
void Xception::ReadImage(const std::string &imgPath, cv::Mat *imageMat) {
    *imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);
}

void Xception::ResizeImage(const cv::Mat &srcImageMat, cv::Mat *dstImageMat) {
...
void Xception::Crop(const cv::Mat &srcImageMat, cv::Mat *dstImageMat) {
    static cv::Rect rectOfImg(10, 10, 299, 299);
    *dstImageMat = srcImageMat(rectOfImg).clone();
}

APP_ERROR Xception::CVMatToTensorBase(const cv::Mat &imageMat,
...
APP_ERROR Xception::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Xception::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Xception::SaveResult(const std::string &imgPath,
...
APP_ERROR Xception::Process(const std::string &imgPath) {
    cv::Mat imageMat;
