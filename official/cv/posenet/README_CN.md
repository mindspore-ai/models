...
| 脚本                    | <https://gitee.com/mindspore/models/tree/r1.5/official/cv/posenet> | <https://gitee.com/mindspore/models/tree/r1.5/official/cv/posenet> |
...
| 微调检查点 | 82.91M (.ckpt文件)                                         | 82.91M (.ckpt文件)                |
| 推理模型        | 41.66M (.mindir文件)                     | 41.66M (.mindir文件)                 |
| 脚本                    | [posenet脚本](https://gitee.com/mindspore/models/tree/r1.5/official/cv/posenet) | [posenet脚本](https://gitee.com/mindspore/models/tree/r1.5/official/cv/posenet) |
