...
class DetectionEngine:
    ...
    def get_img_set(self, anno_json_path):
    ...
    def get_eval_result(self):
        ...
        coco_eval.params.imgIds = self.get_img_set(self.ann_file)
        coco_eval.evaluate()
...
def apply_eval(eval_param_dict):
    ...
    for index, data in enumerate(ds.create_dict_iterator(num_epochs=1)):
        ...
        detection.detect([output_small, output_big], args.per_batch_size, image_shape_, image_id_)
        if index % 100 == 0:
