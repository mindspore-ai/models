...
class Upsample(nn.Cell):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = basic_conv(self.in_channels, self.out_channels, 1)
...
class CspDarkNet53Tiny(nn.Cell):
    ...
    def __init__(self):
        ...
        self.conv1 = basic_conv(32, 64, kernel_size=3, stride=2)
        self.conv2 = CspBlock(64, 64)
        self.conv3 = CspBlock(128, 128)
        self.conv4 = CspBlock(256, 256)
        self.conv5 = basic_conv(512, 512, kernel_size=3)

    def construct(self, x):
        """construct method"""
        # 8, 3, 416, 416->8, 32, 208, 208
        c1 = self.conv0(x)
        # 8, 64, 104, 104
        c2 = self.conv1(c1)
        # 8, 128, 52, 52
        ...
        # 8, 256, 26, 26
        c4, _ = self.conv3(c3)
        # 8, 512, 13, 13  8, 256, 26, 26
        c5, feat1 = self.conv4(c4)
        # 8, 512, 13, 13
        c6 = self.conv5(c5)
        feat2 = c6
        # 8, 512, 13, 13  8, 256, 26, 26
