...
class MultiScaleTrans:
    ...
    def __call__(self, imgs, annos, x1, x2, x3, x4, batch_info):
...
def batch_preprocess_true_box(annos, config, input_shape):
    ...
    return np.array(batch_bbox_true_1), np.array(batch_bbox_true_2), np.array(batch_gt_box1), np.array(batch_gt_box2)
