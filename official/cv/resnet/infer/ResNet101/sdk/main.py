...
if __name__ == '__main__':
    ...
    with open("resnet101.pipeline", 'rb') as f:
        pipelineStr = f.read()
    ...
    for file_name in file_list:
        ...
        empty_data = []
        stream_name = b'im_resnet101'
        in_plugin_id = 0

        unique_id = stream_manager_api.SendDataWithUniqueId(stream_name, in_plugin_id,
                                                            data_input)
        ...
        infer_result = stream_manager_api.GetResultWithUniqueId(stream_name, unique_id, 1000)
