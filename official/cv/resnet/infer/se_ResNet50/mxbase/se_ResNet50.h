...
#ifndef MXBASE_INCEPTIONRESNETV2_H
#define MXBASE_INCEPTIONRESNETV2_H
#include <string>
#include <vector>
#include <memory>
...
class se_ResNet50 {
 public:
     ...
     APP_ERROR ResizeImage(cv::Mat &srcImageMat, cv::Mat &dstImageMat);
     APP_ERROR CVMatToTensorBase(cv::Mat &imageMat, MxBase::TensorBase &tensorBase);
