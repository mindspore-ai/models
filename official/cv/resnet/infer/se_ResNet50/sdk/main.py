...
def inference():
    ...
    with open("./se_resnet50.pipeline", 'rb') as f:
        pipelineStr = f.read()
    ...
    for file_name in file_list:
        ...
        infer_result = stream_manager_api.GetResult(stream_name, unique_id, 10000)
        ...
        if load_dict.get('MxpiClass') is None:
            ...
            with open(os.path.join(res_dir_name, '{}.txt'.format(file_name.substr(0, dot))), 'w') as f_write:
                f_write.write("")
            continue
