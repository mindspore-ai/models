...
| 参数(M)             | 11.2                                                         | 11.2                         |
| 微调检查点 | 86（.ckpt文件）                                         |
| 配置文件                    | [链接](https://gitee.com/mindspore/models/tree/r1.5/official/cv/resnet/config) | [链接](https://gitee.com/mindspore/models/tree/r1.5/official/cv/resnet/config) |
...
|参数(M)   | 60.19 |
|  微调检查点 | 462M（.ckpt文件）  |
| 配置文件  | [链接](https://gitee.com/mindspore/models/tree/r1.5/official/cv/resnet/config)  |
