...
APP_ERROR RdnSuperresolution::Init(const InitParam &initParam) {
...
APP_ERROR RdnSuperresolution::DeInit() {
    model_->DeInit();
...
// padding
APP_ERROR RdnSuperresolution::PaddingImage(cv::Mat *imageSrc, cv::Mat *imageDst, const uint32_t &targetLength) {
...
APP_ERROR RdnSuperresolution::ReadImage(const std::string &imgPath, cv::Mat *imageMat) {
...
APP_ERROR RdnSuperresolution::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase *tensorBase) {
...
APP_ERROR RdnSuperresolution::Inference(std::vector<MxBase::TensorBase> *inputs,
...
APP_ERROR RdnSuperresolution::PostProcess(std::vector<MxBase::TensorBase> *inputs, cv::Mat *imageMat) {
...
APP_ERROR RdnSuperresolution::Process(const std::string &imgPath) {
    cv::Mat imageMat;
