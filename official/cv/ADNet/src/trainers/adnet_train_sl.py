...
def init_net(net, scal, args):
    ...
    net.fc6.bias.set_data(initializer('Zero', shape=net.fc6.bias.shape, dtype=mstype.float32))
    # fc 7
    ...
    net.fc7.bias.set_data(initializer('Zero', shape=net.fc7.bias.shape, dtype=mstype.float32))
