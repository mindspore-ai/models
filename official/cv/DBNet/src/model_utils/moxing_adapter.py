        ...
        def wrapped_func(*args, **kwargs):
            ...
            if config.enable_modelarts:
                if config.data_url:
                    ...
                    config.train.img_dir = os.path.join(config.data_path, "train_images")
                    config.train.gt_dir = os.path.join(config.data_path, "train_gts")
                    config.eval.img_dir = os.path.join(config.data_path, "test_images")
                    config.eval.gt_dir = os.path.join(config.data_path, "test_gts")
                    config.backbone.backbone_ckpt = os.path.join(config.data_path, config.backbone.backbone_ckpt)
