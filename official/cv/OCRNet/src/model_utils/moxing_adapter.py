        ...
        def wrapped_func(*args, **kwargs):
            ...
            if config.modelarts:
                ...
                if config.checkpoint_url:
                    config.checkpoint_path = "/cache/load_checkpoint.ckpt"
                    sync_data(config.checkpoint_url, config.checkpoint_path)
                    print("Preload downloaded: ", config.checkpoint_path)
                if config.train_url:
                    config.output_path = "/cache/output_path"
                ...
                if config.eval_data_url:
                    ...
                    print("Workspace downloaded: ", os.listdir(config.eval_data_path))
