...
"""
sample script of ernie infer using SDK run in docker
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="ernie process")
    ...
    parser.add_argument("--task_name", type=str, default="chnsenticorp", help="task name")
...
def run():
    ...
    stream_name = b'im_ernieclassifier'
    infer_total_time = 0
    # input_ids file list
