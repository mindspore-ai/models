...
class ErniePreTraining(nn.Cell):
    """
    Ernie pretraining network.
...
class ErniePretrainingLoss(nn.Cell):
    """
    ...
    def __init__(self, config):
        super(ErniePretrainingLoss, self).__init__()
...
class ErnieNetworkWithLoss(nn.Cell):
    """
    Provide ernie pre-training loss through network.
    ...
    def __init__(self, config, is_training, use_one_hot_embeddings=False):
        super(ErnieNetworkWithLoss, self).__init__()
        self.bert = ErniePreTraining(config, is_training, use_one_hot_embeddings)
        self.loss = ErniePretrainingLoss(config)
        self.cast = P.Cast()
...
class ErnieTrainOneStepCell(nn.TrainOneStepCell):
    """
    ...
    def __init__(self, network, optimizer, sens=1.0, enable_clip_grad=True):
        super(ErnieTrainOneStepCell, self).__init__(network, optimizer, sens)
        self.cast = P.Cast()
...
class ErnieTrainOneStepWithLossScaleCell(nn.TrainOneStepWithLossScaleCell):
    """
    Encapsulation class of bert network training.
    ...
    def __init__(self, network, optimizer, scale_update_cell=None):
        super(ErnieTrainOneStepWithLossScaleCell, self).__init__(network, optimizer, scale_update_cell)
        self.cast = P.Cast()
        self.degree = 1
...
class ErnieTrainOneStepWithLossScaleCellForAdam(nn.TrainOneStepWithLossScaleCell):
    """
    Encapsulation class of bert network training.
    ...
    """
    def __init__(self, network, optimizer, scale_update_cell=None):
        super(ErnieTrainOneStepWithLossScaleCellForAdam, self).__init__(network, optimizer, scale_update_cell)
        self.cast = P.Cast()
        self.degree = 1
        if self.reducer_flag:
            self.degree = get_group_size()
...
class ErnieTrainAccumulationAllReducePostWithLossScaleCell(nn.Cell):
    """
    Encapsulation class of bert network training.
    ...
    def __init__(self, network, optimizer, scale_update_cell=None, accumulation_steps=1, enable_global_norm=False):
        super(ErnieTrainAccumulationAllReducePostWithLossScaleCell, self).__init__(auto_prefix=False)
...
class ErnieTrainAccumulationAllReduceEachWithLossScaleCell(nn.Cell):
    """
    Encapsulation class of bert network training.
    ...
    """
    def __init__(self, network, optimizer, scale_update_cell=None, accumulation_steps=1, enable_global_norm=False):
        super(ErnieTrainAccumulationAllReduceEachWithLossScaleCell, self).__init__(auto_prefix=False)
        self.network = network
        self.network.set_grad()
        self.weights = optimizer.parameters
        self.optimizer = optimizer
