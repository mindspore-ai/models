...
APP_ERROR GruNerBase::Init(const InitParam &initParam) {
...
APP_ERROR GruNerBase::ReadTensorFromFile(const std::string &file, int32_t *data,
                                         uint32_t size) {
  if (data == NULL) {
...
APP_ERROR GruNerBase::ReadInputTensor(int32_t *data, const std::string &fileName,
                                      uint32_t index,
...
APP_ERROR GruNerBase::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR GruNerBase::PostProcess(std::vector<MxBase::TensorBase> *outputs,
...
APP_ERROR GruNerBase::WriteResult(const std::string &fileName,
...
APP_ERROR GruNerBase::Process(const std::string &inferPath,
                              const std::string &fileName) {
  std::string inputAdjacencyFile = inferPath + "source_ids.txt";
  std::string inputFeatureFile = inferPath + "target_ids.txt";
