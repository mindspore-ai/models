...
- 在`default_config_large.yaml`中设置选项，包括loss_scale、学习率和网络超参数。点击[这里](https://www.mindspore.cn/tutorials/zh-CN/r1.6/advanced/dataset.html)查看更多数据集信息。
...
| 脚本                        | [Transformer 脚本](https://gitee.com/mindspore/models/tree/r1.6/official/nlp/transformer) |
| 模型版本            | large                                                                                  |large|
