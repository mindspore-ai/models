...
- Set options in `default_config_large.yaml`, including loss_scale, learning rate and network hyperparameters. Click [here](https://www.mindspore.cn/tutorials/en/r1.6/advanced/dataset.html) for more information about dataset.
...
| Scripts                    | [Transformer scripts](https://gitee.com/mindspore/models/tree/r1.6/official/nlp/transformer) |
