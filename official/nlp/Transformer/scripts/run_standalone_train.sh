...
echo "bash scripts/run_standalone_train.sh DEVICE_TARGET DEVICE_ID EPOCH_SIZE GRADIENT_ACCUMULATE_STEP DATA_PATH"
echo "for example: bash run_standalone_train.sh Ascend 0 52 8 /path/ende-l128-mindrecord00"
