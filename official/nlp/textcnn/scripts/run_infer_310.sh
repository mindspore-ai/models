...
function preprocess_data()
{
    ...
    python ../preprocess.py --dataset=$dataset_name --result_path=./preprocess_Result/
}
...
function cal_acc()
{
    python ../postprocess.py --result_dir=./result_Files --label_dir=./preprocess_Result/label_ids.npy --dataset=$dataset_name &> acc.log
}
