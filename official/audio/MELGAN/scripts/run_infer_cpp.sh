...
{
    mkdir temp_bin
    python ./cpp_infer/preprocess.py --wav_path=$data_path --bin_path=temp_bin
}
function infer()
{
    ...
    mkdir result_Files
    mkdir time_Result
    ./cpp_infer/out/main --device_type=$device_type --model_path=$model --dataset_path=temp_bin --device_id=$device_id &> infer.log
...
function post_process()
{
    ...
    python ./cpp_infer/preprocess.py --wav_path=result_Files_wav --bin_path=result_Files --mode=2
    rm -rf temp_bin
}
