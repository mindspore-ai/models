...
class NCFModel(nn.Cell):
    ...
    def __init__(self,
        ...
        self.mf_dim = mf_dim
        self.is_row_vector_input = is_row_vector_input
    ...
    def construct(self, user_input, item_input):
        ...
        # embedding_layers
        if self.is_row_vector_input:
            user_input = self.transpose(user_input, (1, 0))
            item_input = self.transpose(item_input, (1, 0))
