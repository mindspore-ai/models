...
if config.backbone == "vgg11":
    from src.vgg11 import MindSporeModel
elif config.backbone == "vgg11_bn":
    from src.vgg11_bn import MindSporeModel
elif config.backbone == "vgg13":
    from src.vgg13 import MindSporeModel
elif config.backbone == "vgg13_bn":
    from src.vgg13_bn import MindSporeModel
elif config.backbone == "vgg16_bn":
    from src.vgg16_bn import MindSporeModel
elif config.backbone == "vgg19_bn":
    from src.vgg19_bn import MindSporeModel
else:
    raise "Unsupported backbone, please check."
