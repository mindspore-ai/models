...
- For more information, please check the resources below：[MindSpore tutorials](https://www.mindspore.cn/tutorials/en/r1.9/index.html), [MindSpore Python API](https://www.mindspore.cn/docs/en/r1.9/index.html).
