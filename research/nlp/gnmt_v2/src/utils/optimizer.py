...
def _check_learning_rate_value(learning_rate, end_learning_rate, decay_steps, power, prim_name):
    """Check the type of inputs."""
    assert isinstance(learning_rate, float) and learning_rate > 0, "learning_rate should be bigger than 0"
    assert isinstance(end_learning_rate, float) and end_learning_rate > 0, \
        "end_learning_rate should be bigger than 0"
    assert isinstance(power, float) and power > 0, "power should be bigger than 0"
