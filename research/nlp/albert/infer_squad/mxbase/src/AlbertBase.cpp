...
APP_ERROR AlbertBase::Init(const InitParam &initParam) {
...
APP_ERROR AlbertBase::ReadTensorFromFile(const std::string &file, uint32_t *data, uint32_t size) {
...
APP_ERROR AlbertBase::ReadInputTensor(const std::string &fileName, uint32_t index,
...
APP_ERROR AlbertBase::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR AlbertBase::PostProcess(std::vector<MxBase::TensorBase> *outputs, std::vector<uint32_t> *argmax, \
    ...
    std::string resultPathName = "../data/input/11_data";
...
APP_ERROR AlbertBase::CountPredictResult(const std::string &labelFile, const std::vector<uint32_t> &argmax) {
    uint32_t data[MAX_LENGTH] = {0};
...
APP_ERROR AlbertBase::WriteResult(const std::string &fileName, const std::vector<uint32_t> &argmax) {
...
APP_ERROR AlbertBase::Process(const std::string &inferPath, const std::string &fileName, bool eval) {
    std::vector<MxBase::TensorBase> inputs = {};
