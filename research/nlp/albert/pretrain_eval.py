...
from src.utils import AlbertMetric
from src.model_utils.config import config as cfg, bert_net_cfg
from src.albert_for_pre_training import AlbertPretrainEval
...
def bert_predict():
    ...
    net_for_pretraining = AlbertPretrainEval(bert_net_cfg)
...
def MLM_eval():
    ...
    net = Model(net_for_pretraining, eval_network=net_for_pretraining,
                metrics={'name': AlbertMetric(cfg.batch_size)})
