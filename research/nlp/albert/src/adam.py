...
# ============================================================================
"""AdamWeightDecayForBert, a customized Adam for albert. Input: gradient, overflow flag."""
import numpy as np
...
class AdamWeightDecayForAlbert(Optimizer):
    """
   ...
   """
    def __init__(self, params, learning_rate=1e-3, beta1=0.9, beta2=0.999, eps=1e-6, weight_decay=0.0):
        super(AdamWeightDecayForAlbert, self).__init__(learning_rate, params, weight_decay)
