...
def extra_operations(cfg):
    ...
    if cfg.description == 'run_pretrain':
        ...
        cfg.large_net_cfg.dtyptrain_data_file_pathe = parse_dtype(cfg.large_net_cfg.dtype)
        ...
        if cfg.albert_network == 'base':
            ...
            _albert_net_cfg = cfg.base_net_cfg
        elif cfg.albert_network == 'large':
            cfg.batch_size = cfg.large_batch_size
            _albert_net_cfg = cfg.large_net_cfg
        elif cfg.albert_network == 'xlarge':
            cfg.batch_size = cfg.xlarge_batch_size
            _albert_net_cfg = cfg.xlarge_net_cfg
        elif cfg.albert_network == 'xxlarge':
            cfg.batch_size = cfg.xxlarge_batch_size
            _albert_net_cfg = cfg.xxlarge_net_cfg
        else:
            pass
        cfg.albert_net_cfg = AlbertConfig(**_albert_net_cfg.__dict__)

    elif cfg.description == 'run_squad_v1':
        ...
        cfg.albert_net_cfg.dtype = mstype.float32
        cfg.albert_net_cfg.compute_type = mstype.float16
        cfg.albert_net_cfg = AlbertConfig(**cfg.albert_net_cfg.__dict__)
...
def get_config():
    ...
    parser.add_argument("--config_path", type=get_abs_path, default="../../task_classifier_config.yaml",
...
config = get_config()
albert_net_cfg = config.albert_net_cfg
if config.description in ('run_classifier', 'run_squad_v1'):
