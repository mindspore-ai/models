...
```shell
# Ascend310 inference
bash run_infer_310.sh [MINDIR_PATH] [LABEL_PATH] [DATA_FILE_PATH] [DATASET_FORMAT] [NEED_PREPROCESS] [TASK_TYPE] [EVAL_JSON_PATH] [VOCAB_FILE_PATH] [SPM_MODEL_FILE] [DEVICE_ID]
...
# An example of task SquAD v1:
# The predict_feature_left_file_v1.pkl file needs to specify the path. If the file does not exist, it will be automatically generated and saved to the specified path during preprocess.
bash run_infer_310.sh /your/path/squad.mindir /your/path/predict_feature_left_file_v1.pkl y squadv1 /your/path/dev-v1.1.json /your/path/30k-clean.vocab /your/path/30k-clean.model 1
```
...
`SPM_MODEL_FILE` is spm file of TensorFlow Albert, must be provided if task type is squadv1.
...
Please check the official [homepage](https://gitee.com/mindspore/mindspore/tree/r1.5/model_zoo).