...
#ifndef MXBASE_ROTATE_H
#define MXBASE_ROTATE_H
#include <memory>
#include <string>
#include <vector>
...
class rotate {
 public:
  ...
  APP_ERROR Process(const std::vector<uint32_t> &positive_sample, const std::vector<uint32_t> &negative_sample,
 ...
 private:
  std::shared_ptr<MxBase::ModelInferenceProcessor> model_rotate;
