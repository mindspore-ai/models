...
def parse_args():
    ...
    data_g.add_arg("predict_file", str, "data/ReCoRD/dev.json",
                   "ReCoRD json for predictions. E.g. dev.json or test.json.")
    ...
    mem_settings_g.add_arg('retrieved_synset_path', str,
                           'data/retrieve_wordnet/output_record/retrived_synsets.data',
    ...
    mem_settings_g.add_arg('train_retrieved_nell_concept_path', str,
                           'data/retrieve_nell/output_record/train.retrieved_nell_concepts.data',
                           'path of retrieved concepts for trainset')
    mem_settings_g.add_arg('dev_retrieved_nell_concept_path', str,
                           'data/retrieve_nell/output_record/dev.retrieved_nell_concepts.data',
