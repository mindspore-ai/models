...
def parse_args():
    ...
    model_g.add_arg("bert_config_path", str, "data/cased_L-24_H-1024_A-16/bert_config.json", "Path to the json file "
                                                                                             "for bert model config.")
    ...
    train_g.add_arg("learning_rate", float, 6e-5, "Learning rate used to train with warmup.")
    ...
    data_g.add_arg("train_file", str, "data/ReCoRD/train.json", "ReCoRD json for training. E.g., train.json.")
    data_g.add_arg("predict_file", str, "data/ReCoRD/dev.json",
                   "ReCoRD json for predictions. E.g. dev-v1.1.json or test.json.")
    ...
    mem_settings_g.add_arg('retrieved_synset_path', str,
                           '/retrieve_wordnet/output_record/retrived_synsets.data',
    ...
    mem_settings_g.add_arg('dev_retrieved_nell_concept_path', str,
                           '/retrieve_nell/output_record/dev.retrieved_nell_concepts.data',
    ...
    parser.add_argument('--load_pretrain_checkpoint_path', type=str, default="data/cased_L-24_H-1024_A-16/roberta.ckpt",
                        help='')
    parser.add_argument('--train_mindrecord_file', type=str, default="ReCoRD/train.mindrecord", help='')
    parser.add_argument('--predict_mindrecord_file', type=str, default="ReCoRD/dev.mindrecord", help='')
    ...
    parser.add_argument('--load_checkpoint_path', type=str,
                        default="output/finetune_checkpoint/KTNET_record-1_8409.ckpt", help='')
...
def run_ktnet(args):
    ...
    if args.do_predict:
        eval_concept_settings = {
            'tokenization_path': args.data_url + '/tokenization_record/tokens/dev.tokenization.{}.data'.format(
