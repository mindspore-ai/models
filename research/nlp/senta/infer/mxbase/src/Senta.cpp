...
APP_ERROR Senta::Init(const InitParam &initParam) {
...
APP_ERROR Senta::ReadTensorFromFile(const std::string &file, uint32_t *data) {
    if (data == NULL) {
...
APP_ERROR Senta::ReadInputTensor(const std::string &fileName, uint32_t index,
...
APP_ERROR Senta::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR Senta::PostProcess(std::vector<MxBase::TensorBase> *outputs, std::vector<uint32_t> *argmax) {
...
APP_ERROR Senta::CountPredictResult(const std::string &labelFile, const std::vector<uint32_t> &argmax) {
    uint32_t data[1] = {0};
...
APP_ERROR Senta::WriteResult(const std::string &fileName, const std::vector<uint32_t> &argmax) {
...
APP_ERROR Senta::Process(const std::string &inferPath, const std::string &fileName, bool eval) {
    std::vector<MxBase::TensorBase> inputs = {};
