...
# ============================================================================
"""
Luke model modification for relation classification task
"""
...
from src.luke.tacred_robert import BertEmbeddings
from src.luke.tacred_robert import BertEncoder
from src.luke.tacred_robert import BertIntermediate
from src.luke.tacred_robert import BertOutput
from src.luke.tacred_robert import BertSelfOutput
from src.luke.tacred_robert import RobertaEmbeddings
from src.luke.tacred_robert import TransposeForScores
...
class EntityAwareSelfAttention(nn.Cell):
    ...
    def construct(self, word_hidden_states, entity_hidden_states, attention_mask):
        ...
        e2w_key_layer = w2w_key_layer
        e2e_key_layer = w2e_key_layer
