...
# This file refers to https://github.com/openai/CLIP/blob/main/clip/simple_tokenizer.py
import os
import gzip
import html
...
from ldm.models.clip_zh.utils import is_control, is_whitespace, is_chinese_char, \
