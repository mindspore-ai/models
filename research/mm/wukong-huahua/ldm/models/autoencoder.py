...
# This file refers to https://github.com/brycedrennan/imaginAIry/blob/master/imaginairy/modules/autoencoder.py
import mindspore
...
class AutoencoderKL(nn.Cell):
    def __init__(self,
        ...
        self.quant_conv = nn.Conv2d(2*ddconfig["z_channels"], 2*embed_dim, 1,
                                    pad_mode="valid", has_bias=True).to_float(self.dtype)
