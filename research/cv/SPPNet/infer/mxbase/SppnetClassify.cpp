...
#include <string>
#include <vector>
#include "SppnetClassify.h"
#include "MxBase/DeviceManager/DeviceManager.h"
#include "MxBase/Log/Log.h"

APP_ERROR SPPnetClassify::Init(const InitParam &initParam) {
...
APP_ERROR SPPnetClassify::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR SPPnetClassify::ReadImage(const std::string &imgPath, cv::Mat &imageMat) {
    imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);
    return APP_ERR_OK;
}

APP_ERROR SPPnetClassify::CenterCropImage(const cv::Mat &img, cv::Mat &cropImg) {
...
APP_ERROR SPPnetClassify::Resize(const cv::Mat &srcImageMat, cv::Mat &dstImageMat) {
...
APP_ERROR SPPnetClassify::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase) {
...
APP_ERROR SPPnetClassify::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR SPPnetClassify::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR SPPnetClassify::SaveInferResult(const std::string &imagePath,
...
APP_ERROR SPPnetClassify::Process(const std::string &imgPath) {
    cv::Mat imageMat;
