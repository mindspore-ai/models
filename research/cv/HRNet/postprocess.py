...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="HRNet Semantic Segmentation 310 Inference.")
...
def main(args):
    ...
    for result in result_list:
        ...
        output = np.fromfile(os.path.join(args.result_path, prefix + "_0.bin"),
                             dtype=np.float32).reshape(1, 19, 1024, 2048)
