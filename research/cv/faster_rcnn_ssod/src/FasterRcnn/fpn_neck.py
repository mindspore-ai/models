...
class FeatPyramidNeck(nn.Cell):
    ...
    def __init__(self,
        ...
        self.interpolate1 = P.ResizeNearestNeighbor(feature_shapes[2])      # ori (48, 80)
        self.interpolate2 = P.ResizeNearestNeighbor(feature_shapes[1])      # ori (96, 160)
        self.interpolate3 = P.ResizeNearestNeighbor(feature_shapes[0])      # ori (192, 320)
