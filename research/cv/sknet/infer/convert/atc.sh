...
# ============================================================================
model="../data/models/sknet.air"
output="../data/models/sknet"
...
if [[ $1 == --help || $1 == -h ]];then
    ...
    --model                  set model place, default: --model=../data/models/sknet.air
    --output                 set the name and place of OM model, default: --output=../data/models/sknet
    --soc_version            set the soc_version, default: --soc_version=Ascend310
    --input_shape            set the input node and shape, default: --input_shape='x:32,3,224,224'
