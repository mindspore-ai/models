...
from .network_blocks import BaseConv, BaseConvStem, CSPLayer, DWConv, ResLayer, SPPBottleneck
...
class Darknet(nn.Cell):
    ...
    def __init__(
        ...
        num_blocks = Darknet.depth2block.get('depth', 64)
    ...
    def construct(self, x):
        ...
        x = self.dark5(x)
        outputs["dark5"] = x
        return outputs.get("dark3"), outputs.get("dark4"), outputs.get("dark5")
