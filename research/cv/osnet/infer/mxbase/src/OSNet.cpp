...
APP_ERROR OSNet::Init(const InitParam &initParam) {
...
APP_ERROR OSNet::DeInit() {
    this->model_->DeInit();
    MxBase::DeviceManager::GetInstance()->DestroyDevices();
    return APP_ERR_OK;
}

APP_ERROR OSNet::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR OSNet::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR OSNet::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR  OSNet::WriteResult(const std::string &imageFile, std::vector<MxBase::TensorBase> outputs) {
...
APP_ERROR OSNet::Process(const std::string &inferPath, const std::string &fileName) {
