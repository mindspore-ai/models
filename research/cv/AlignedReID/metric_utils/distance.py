...
def compute_dist(array1, array2, metric='euclidean'):
    """ Compute Compute the euclidean or cosine distance of all pairs.
    Args:
...
def shortest_dist(dist_mat):
    """ Computing distance of image parts
    Args:
...
def parallel_local_dist(x, y):
    ...
    y = y.reshape([N * n, d])
    # shape [M * m, N * n]
    dist_mat = compute_dist(x, y, metric='euclidean')
