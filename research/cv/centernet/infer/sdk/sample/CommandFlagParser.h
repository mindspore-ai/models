 ...
 */
#ifndef RESEARCH_CV_CENTERNET_INFER_SDK_SAMPLE_COMMANDFLAGPARSER_H_
#define RESEARCH_CV_CENTERNET_INFER_SDK_SAMPLE_COMMANDFLAGPARSER_H_
...
#define DEFINE_uint32(name, default_arg, desc)                               \
    static uint32_t FLAGS_##name(default_arg);                               \
    static OptionManager::OptionInitializer g_uint32_t_##name##_initializer( \
        &FLAGS_##name, #name, "uint32_t", desc);
        ...
        void SetValue(std::string val) {
            if (type == "string") {
                ...
                *reinterpret_cast<uint32_t*>(ptr) =
                    static_cast<uint32_t>(stoul(val));
            } else if (type == "bool") {
...
#endif  // RESEARCH_CV_CENTERNET_INFER_SDK_SAMPLE_COMMANDFLAGPARSER_H_
