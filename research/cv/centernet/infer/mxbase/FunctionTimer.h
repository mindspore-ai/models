 ...
 */
#ifndef RESEARCH_CV_CENTERNET_INFER_MXBASE_FUNCTIONTIMER_H_
#define RESEARCH_CV_CENTERNET_INFER_MXBASE_FUNCTIONTIMER_H_
...
#endif  // RESEARCH_CV_CENTERNET_INFER_MXBASE_FUNCTIONTIMER_H_
