 ...
 */
#ifndef RESEARCH_CV_CENTERNET_INFER_MXBASE_COMMANDFLAGPARSER_H_
#define RESEARCH_CV_CENTERNET_INFER_MXBASE_COMMANDFLAGPARSER_H_
...
#endif  // RESEARCH_CV_CENTERNET_INFER_MXBASE_COMMANDFLAGPARSER_H_
