...
class Yolov3_tiny {
 public:
    ...
    static const int IMG_H = 640;
    static const int IMG_W = 640;
    static const int FEATURE_NUM = 2048;
    static const int Output_small = 1 * 3 * 20 * 20 * 85;
    static const int Output_big = 1 * 3 * 40 * 40 * 85;
    ...
    APP_ERROR ArrayToTensorBase(const std::vector<float> &imgData, MxBase::TensorBase &tensorBase);
 ...
 private:
    APP_ERROR SaveResult(MxBase::TensorBase *tensor_0, MxBase::TensorBase *tensor_1,
