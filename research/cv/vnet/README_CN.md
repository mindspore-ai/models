...
- 生成config json文件用于多卡训练。
    - [简易教程](https://gitee.com/mindspore/models/tree/r1.9/utils/hccl_tools)
    - 详细配置方法请参照[官网教程](https://www.mindspore.cn/tutorials/experts/zh-CN/r1.9/parallel/train_ascend.html#配置分布式环境变量)。
...
hccl.json用[此方法](https://gitee.com/mindspore/models/tree/r1.9/utils/hccl_tools)生成并放在script文件夹下
...
| 脚本 | [链接](https://gitee.com/mindspore/models/tree/r1.9/research/cv/vnet) | [链接](https://gitee.com/mindspore/models/tree/r1.9/research/cv/vnet) |
