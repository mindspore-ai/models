...
#ifndef MXBASE_vnet_H
#define MXBASE_vnet_H
#include <memory>
#include <string>
#include <vector>
#include "acl/acl.h"
...
class vnet {
 public:
  ...
  APP_ERROR Process(const std::string &index, const std::string &image_path,
 ...
 private:
  std::shared_ptr<MxBase::ModelInferenceProcessor> model_vnet;
