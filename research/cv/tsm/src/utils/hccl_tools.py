...
def main():
    ...
    if not os.path.exists(os.path.join(table_path, 'src', 'config', 'distributed')):
        os.makedirs(os.path.join(table_path, 'src', 'config', 'distributed'))
    table_fn = os.path.join(table_path, 'src', 'config', 'distributed',
