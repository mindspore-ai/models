...
def _conv3x3(in_channel, out_channel, stride=1, use_se=False, res_base=True):
    if use_se:
...
def _conv1x1(in_channel, out_channel, stride=1, use_se=False, res_base=True):
    if use_se:
...
def _conv7x7(in_channel, out_channel, stride=1, use_se=False, res_base=True):
    if use_se:
