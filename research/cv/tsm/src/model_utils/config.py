...
def get_config():
    ...
    "../config/tsm_sthv2_config.yaml"), help="Config file path")
    path_args, _ = parser.parse_known_args()
    default, helper, choices = parse_yaml(os.path.join(current_dir, path_args.config_path))
    args = parse_cli_to_yaml(parser=parser, cfg=default, helper=helper,
                             choices=choices, cfg_path=os.path.join(current_dir, path_args.config_path))
