...
wget https://www.robots.ox.ac.uk/~vgg/data/parisbuildings/paris_1-v1.tgz --no-check-certificate
wget https://www.robots.ox.ac.uk/~vgg/data/parisbuildings/paris_2-v1.tgz --no-check-certificate
wget https://www.robots.ox.ac.uk/~vgg/data/parisbuildings/corrupt.txt --no-check-certificate
tar -xzvf paris_1-v1.tgz
tar -xzvf paris_2-v1.tgz
cd paris
...
rm -rf paris
wget https://www.robots.ox.ac.uk/~vgg/data/parisbuildings/paris_120310.tgz --no-check-certificate
