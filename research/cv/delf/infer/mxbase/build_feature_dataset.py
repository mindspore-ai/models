...
parser = argparse.ArgumentParser(description='delf Example')

parser.add_argument('--ann_file', type=str, default="features.ann")
...
parser.add_argument('--ann_path', type=str, default="./retrieval_dataset")
