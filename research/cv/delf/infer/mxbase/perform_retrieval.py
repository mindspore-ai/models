...
parser.add_argument('--ann_file', type=str, default="./retrieval_dataset/features.ann")
parser.add_argument('--query_features_dir', type=str, default="./eval_features")
parser.add_argument('--index_features_dir', type=str, default="./eval_features")
parser.add_argument('--image_path', type=str, default="../data/ox")
parser.add_argument('--gt_path', type=str, default="../data/ox_gt")

parser.add_argument('--output_dir', type=str, default="./retrieval_dataset/process$i")
parser.add_argument('--rank_file', type=str, default="ranks")
