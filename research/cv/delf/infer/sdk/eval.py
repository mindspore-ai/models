...
parser.add_argument('--ranks_path', type=str, default="./retrieval_dataset")
parser.add_argument('--ranks_file', type=str, default="ranks")
parser.add_argument('--image_path', type=str, default="../data/ox")
parser.add_argument('--gt_path', type=str, default="../data/ox_gt")
parser.add_argument('--output_dir', type=str, default="./")
parser.add_argument('--metric_name', type=str, default="mAP.txt")
