...
def parse_args():
    ...
    parser.add_argument('--result_path', required=True, default=None, help='Location of result.')
    parser.add_argument('--data_path', required=True, default=None, help='Location of .npy file.')
