...
def args_parser():
    ...
    parser.add_argument("--train_url", type=str, default="obs://mindx-user-5/c3d_modelArts/output/", help="test")
    parser.add_argument("--data_url", type=str, default="obs://mindx-user-5/c3d_modelArts/data/", help="test")
    parser.add_argument("--num_classes", type=str, default="101", help="the number of classes to be 101 or 51")
...
def train(args):
    train_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), "../train.py")
