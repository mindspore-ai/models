...
echo "for example: bash run_distribute_train_gpu.sh 8 500 0.05 coco /models/refinedet.ckpt(optional) 200(optional)"
...
cd $BASE_PATH/../ || exit
python train.py --only_create_dataset=True --run_platform="GPU" --dataset=$4 > mindrecord.log 2>&1
