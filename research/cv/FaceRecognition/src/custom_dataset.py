    ...
    def __init__(self, root, cache_path, is_distributed):
        if not os.path.isfile(cache_path):
            ...
            with open(cache_path, "rb") as fr:
                ...
                self.classes, self.classes_to_idx, self.samples, self.id2range = (
                    cache["classes"],
...
class CustomDataset:
    ...
    def __init__(self, root, cache_path, is_distributed=1, transform=None, target_transform=None, loader=pil_loader):
