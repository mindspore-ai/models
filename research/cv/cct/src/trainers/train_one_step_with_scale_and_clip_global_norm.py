...
class TrainOneStepWithLossScaleCellGlobalNormClip(nn.TrainOneStepWithLossScaleCell):
    ...
    Args:
        ...
        use_global_nrom(bool): Whether apply global norm before optimizer. Default: True.
        clip_global_norm_value (Number): Gradients global norm's value. Default: 1.
    """

    def __init__(self, network, optimizer, scale_sense=1.0, clip_global_norm=True, clip_global_norm_value=1.0):
