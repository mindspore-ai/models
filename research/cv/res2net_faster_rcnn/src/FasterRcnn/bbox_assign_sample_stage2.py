...
class BboxAssignSampleForRcnn(nn.Cell):
    ...
    def get_assigned_gt_inds3(self, max_overlaps_w_ac, overlaps, assigned_gt_inds3):
        """get_assigned_gt_inds3"""
    ...
    def construct(self, gt_bboxes_i, gt_labels_i, valid_mask, bboxes, gt_valids):
        ...
        assigned_gt_inds3 = self.get_assigned_gt_inds3(max_overlaps_w_ac, overlaps, assigned_gt_inds3)
        ...
        num_pos = self.sum_inds(
            self.cast(self.logicalnot(valid_pos_index), self.ms_type), -1
        )
