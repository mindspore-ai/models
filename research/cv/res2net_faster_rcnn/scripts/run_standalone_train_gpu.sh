...
if [ $# -le 2 ]
then 
    echo "Usage: bash run_standalone_train_gpu.sh [PRETRAINED_PATH] [BACKBONE] [COCO_ROOT] [MINDRECORD_DIR](option)"
exit 1
fi

if [ $2 != "res2net_v1_50" ] && [ $2 != "res2net_v1.5_50" ] && [ $2 != "res2net_v1_101" ] && [ $2 != "res2net_v1_152" ]
then 
  echo "error: the selected backbone must be res2net_v1_50, res2net_v1.5_50, res2net_v1_101, res2net_v1_152"
exit 1
fi
...
if [ $# -ge 1 ]; then
  if [ $2 == 'res2net_v1.5_50' ]; then
    CONFIG_FILE="${BASE_PATH}/../default_config.yaml"
  elif [ $2 == 'res2net_v1_101' ]; then
    CONFIG_FILE="${BASE_PATH}/../default_config_101.yaml"
  elif [ $2 == 'res2net_v1_152' ]; then
    CONFIG_FILE="${BASE_PATH}/../default_config_152.yaml"
  elif [ $2 == 'res2net_v1_50' ]; then
    CONFIG_FILE="${BASE_PATH}/../default_config.yaml"
  else
