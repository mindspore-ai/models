...
if [ $3 != "res2net_v1_50" ] && [ $3 != "res2net_v1.5_50" ] && [ $3 != "res2net_v1_101" ] && [ $3 != "res2net_v1_152" ]
then 
...
if [ $# -ge 1 ]; then
  if [ $3 == 'res2net_v1.5_50' ]; then
    CONFIG_FILE="${BASE_PATH}/default_config.yaml"
  elif [ $3 == 'res2net_v1_101' ]; then
    CONFIG_FILE="${BASE_PATH}/default_config_101.yaml"
  elif [ $3 == 'res2net_v1_152' ]; then
    CONFIG_FILE="${BASE_PATH}/default_config_152.yaml"
  elif [ $3 == 'res2net_v1_50' ]; then
    CONFIG_FILE="${BASE_PATH}/default_config.yaml"
  else
