...
if [ $# -le 3 ]
then 
    echo "Usage: bash run_eval_ascend.sh [VALIDATION_JSON_FILE] [CHECKPOINT_PATH] [BACKBONE] [COCO_ROOT] [MINDRECORD_DIR](option)"
exit 1
fi

if [ $3 != "res2net_50" ] && [ $3 != "res2net_101" ] && [ $3 != "res2net_152" ]
then 
...
if [ $# -ge 1 ]; then
  if [ $3 == 'res2net_50' ]; then
    CONFIG_FILE="${BASE_PATH}/../default_config.yaml"
  elif [ $3 == 'res2net_101' ]; then
    CONFIG_FILE="${BASE_PATH}/../default_config_101.yaml"
  elif [ $3 == 'res2net_152' ]; then
