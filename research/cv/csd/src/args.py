...
parser.add_argument('--neg_num', type=float, default=10)
parser.add_argument('--contra_lambda', type=float, default=1, help='weight of contra_loss')
parser.add_argument('--vgg_ckpt', type=str, default='./vgg19_ImageNet.ckpt')

# ModelArts
parser.add_argument('--modelArts_mode', type=ast.literal_eval, default=False,
                    help='train on modelarts or not, default is False')
parser.add_argument('--data_url', type=str, default='', help='the directory path of data file')
parser.add_argument('--train_url', type=str, default='', help='the directory path of saved file')
