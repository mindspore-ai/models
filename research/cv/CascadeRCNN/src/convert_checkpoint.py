...
# ===========================================================================
"""
convert resnet101 pretrain model to cascade_rcnn backbone pretrain model
"""
import argparse
...
def load_weights(model_path, use_fp16_weight):
    """
    load resnet101 pretrain checkpoint file.

    Args:
        model_path (str): resnet101 pretrain checkpoint file .
...
if __name__ == "__main__":
    ...
    save_checkpoint(parameter_list, "resnet101_backbone.ckpt")
