...
class SdkApi:
    ...
    def _send_protobuf(self, stream_name, plugin_id, element_name, buf_type, pkg_list):
        """send protobuf"""
    ...
    def send_img_input(self, stream_name, plugin_id, element_name, input_data, img_size):
        """ send image input """
    ...
    def send_tensor_input(self, stream_name, plugin_id, element_name, input_data, input_shape, data_type):
        """send tensor input"""
