...
# ============================================================================
"""TextFuseNet training network wrapper."""
...
class WithLossCell(nn.Cell):
    ...
    def construct(self, x, img_shape, gt_bboxe, gt_label, gt_num, gt_mask):
        loss1, loss2, loss3, loss4, loss5, loss6, loss7, loss8 = self._backbone(x, img_shape, gt_bboxe, gt_label,
                                                                                gt_num, gt_mask)
