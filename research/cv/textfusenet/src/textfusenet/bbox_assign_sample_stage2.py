...
# ============================================================================
"""TextFuseNet tpositive and negative sample screening for Rcnn."""
...
class BboxAssignSampleForRcnn(nn.Cell):
    ...
    def construct(self, gt_bboxes_i, gt_labels_i, valid_mask, bboxes, gt_valids, gt_masks_i):
        """assign forward for the second stage"""
        ...
        box_ids = F.range(Tensor(0, mstype.int32),
                          Tensor(cfg.num_expected_pos_stage2, mstype.int32),
