...
def data_to_mindrecord_byte_image(dataset="coco", is_training=True, prefix="textfusenet.mindrecord", file_num=8):
    ...
    writer.add_schema(textfusenet_json, "textfusenet_json")
...
def create_textfusenet_dataset(mindrecord_file, batch_size=2, device_num=1, rank_id=0,
                               is_training=True, num_parallel_workers=8):
    """Create TextFuseNet dataset with MindDataset."""
    cv2.setNumThreads(0)
