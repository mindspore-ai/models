...
def resnet50():
    ...
    return ResNet(ResidualBlock,
                  ...
                  [64, 256, 512, 1024],
                  [256, 512, 1024, 2048],
                  [1, 2, 2, 1])  # Last stride is 2 by default
