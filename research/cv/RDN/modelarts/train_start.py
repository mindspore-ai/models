...
def _parse_args():
    """parse arguments"""
    parser = argparse.ArgumentParser(description='train and export rdn on modelarts')
    # train output path
    ...
    parser.add_argument("--export_file_name", type=str, default="rdn", help="output file name.")
