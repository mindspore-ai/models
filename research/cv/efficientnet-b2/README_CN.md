...
```shell
epoch 1：epoch time: 664728.258, per step time: 1063.585, avg loss: 5.814
epoch 2: epoch time: 327862.813, per step time: 524.581, avg loss: 4.786
epoch 3: epoch time: 327541.813, per step time: 524.066, avg loss: 4.152
epoch 4: epoch time: 327778.813, per step time: 524.445, avg loss: 3.719
epoch 5: epoch time: 327954.813, per step time: 524.726, avg loss: 3.342
```
...
```shell
result: {'Loss': 1.7529109918154202, 'Top_1_Acc': 0.7955128205128205, 'Top_5_Acc': 0.9459334935897435} ckpt = ./checkpoint/model_0/Efficientnet_b2-rank0-350_625.ckpt
```
