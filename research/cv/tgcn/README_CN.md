...
Ascend多卡训练中`[RANK_TABLE]`为相应RANK_TABLE_FILE文件路径（如8卡训练使用的`./rank_table_8pcs.json`），RANK_TABLE_FILE可按[此方法](https://gitee.com/mindspore/models/tree/r1.9/utils/hccl_tools)生成。`[RANK_SIZE]`为训练所调用卡的数量，`[DEVICE_START]`为起始卡号，`[DATA_PATH]`为数据集存放根目录。
...
| 脚本 | [训练脚本](https://gitee.com/mindspore/models/tree/r1.9/research/cv/tgcn/train.py) |
...
| 脚本 | [评估脚本](https://gitee.com/mindspore/models/tree/r1.9/research/cv/tgcn/eval.py) |
...
# [ModelZoo主页](#目录)
 ...
 [T-GCN](https://gitee.com/mindspore/models/tree/r1.9/research/cv/tgcn)