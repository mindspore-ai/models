...
| Scripts | [T-GCN training script](https://gitee.com/mindspore/models/blob/r1.9/research/cv/tgcn/train.py) |
...
| $R^2$ | 0.8458 |
| VAR | 0.8461 |
| Scripts | [T-GCN evaluation script](https://gitee.com/mindspore/models/blob/r1.9/research/cv/tgcn/eval.py) |
