...
class gan {
 public:
  ...
  APP_ERROR Process(const std::string &image_path, const InitParam &initParam, const std::string &out_path);
 ...
 private:
  std::shared_ptr<MxBase::ModelInferenceProcessor> model_gan;
