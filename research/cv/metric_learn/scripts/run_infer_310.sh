...
function preprocess_data()
{
    ...
    python ../preprocess.py --data_path=$data_path --result_path=./preprocess_Result &> preprocess.log
}
...
function infer()
{
    ...
    mkdir result_Files
    mkdir time_Result
    ../ascend310_infer/src/main --mindir_path=$model --dataset_path=./preprocess_Result/img_data --device_id=$device_id  &> infer.log
}
