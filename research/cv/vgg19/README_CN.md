...
> 关于rank_table.json，可以参考[分布式并行训练](https://www.mindspore.cn/tutorials/zh-CN/r1.3/distributed_training.html)。
...
| 脚本                  |[VGG19](https://gitee.com/mindspore/mindspore/tree/r1.3/model_zoo/research/cv/vgg19) |                   |
