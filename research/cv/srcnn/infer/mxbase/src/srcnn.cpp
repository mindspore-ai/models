...
APP_ERROR Srcnn::Init(const InitParam &initParam) {
...
APP_ERROR Srcnn::DeInit() {
    this->model_->DeInit();
    MxBase::DeviceManager::GetInstance()->DestroyDevices();
    return APP_ERR_OK;
}

APP_ERROR Srcnn::ReadTensorFromFile(const std::string &file, float *data) {
    if (data == NULL) {
...
APP_ERROR Srcnn::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR Srcnn::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR  Srcnn::WriteResult(const std::string &imageFile, std::vector<MxBase::TensorBase> outputs) {
...
APP_ERROR Srcnn::Process(const std::string &inferPath, const std::string &fileName) {
