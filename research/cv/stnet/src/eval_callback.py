...
class EvalCallBack(Callback):
    ...
    def epoch_end(self, run_context):
        ...
        # adjust lr
        if cur_epoch in (20, 40):
            ops = cb_params.optimizer
            curr_lr = ops.learning_rate.asnumpy()
            ops.learning_rate.assign_value(ms.Tensor(curr_lr*0.1, ms.float32))
            print("curr_epoch:", cur_epoch, "curr_lr:", ops.learning_rate.asnumpy())
