...
class ResNetFea(nn.Cell):
    ...
    def __init__(self,
        ...
        self.layer1 = self._make_layer(conv_block,
                                       layer_nums[0],
        ...
        self.layer2 = self._make_layer(deform_block,
                                       layer_nums[1],
                                       ...
                                       training=bn_training,
                                       weights_update=True)
        self.layer3 = self._make_layer(deform_block,
                                       layer_nums[2],
                                       ...
                                       training=bn_training,
                                       weights_update=True)
        self.layer4 = self._make_layer(deform_block,
                                       layer_nums[3],
...
class ResidualBlockUsingDCN(nn.Cell):
    """
    ResNet V1 residual block definition using Deformable convolution opertor.
    ...
    def __init__(self,
                 ...
                 training=False,
                 weights_update=False):
        super(ResidualBlockUsingDCN, self).__init__()
        ...
        self.conv1 = _conv(in_channels, out_chls, kernel_size=1, stride=1, padding=0)
        self.bn1 = _BatchNorm2dInit(out_chls, momentum=momentum, affine=self.affine, use_batch_statistics=training)
        self.defconv = DeformConv2d(out_chls, out_chls, kernel_size=3, stride=stride, pad_mode='pad',
