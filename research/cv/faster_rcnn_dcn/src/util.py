...
summary_init = {
    'Average Precision  (AP) @[ IoU=0.50:0.95 | area=   all | maxDets=100 ]': _init_value,
    'Average Precision  (AP) @[ IoU=0.50      | area=   all | maxDets=100 ]': _init_value,
    'Average Precision  (AP) @[ IoU=0.75      | area=   all | maxDets=100 ]': _init_value,
    'Average Precision  (AP) @[ IoU=0.50:0.95 | area= small | maxDets=100 ]': _init_value,
    'Average Precision  (AP) @[ IoU=0.50:0.95 | area=medium | maxDets=100 ]': _init_value,
    'Average Precision  (AP) @[ IoU=0.50:0.95 | area= large | maxDets=100 ]': _init_value,
    'Average Recall     (AR) @[ IoU=0.50:0.95 | area=   all | maxDets=  1 ]': _init_value,
    'Average Recall     (AR) @[ IoU=0.50:0.95 | area=   all | maxDets= 10 ]': _init_value,
    'Average Recall     (AR) @[ IoU=0.50:0.95 | area=   all | maxDets=100 ]': _init_value,
    'Average Recall     (AR) @[ IoU=0.50:0.95 | area= small | maxDets=100 ]': _init_value,
    'Average Recall     (AR) @[ IoU=0.50:0.95 | area=medium | maxDets=100 ]': _init_value,
