...
2. 预训练模型是在ImageNet2012上训练的ResNet-50检查点。你可以使用ModelZoo中 [resnet50](https://gitee.com/mindspore/models/tree/r1.8/official/cv/resnet) 脚本来训练。
3. BACKBONE_MODEL是通过modelzoo中的ResNet-50 [resnet50](https://gitee.com/mindspore/models/tree/r1.8/official/cv/resnet) 脚本训练的。
