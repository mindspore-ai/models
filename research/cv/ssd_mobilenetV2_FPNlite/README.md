...
To train the model, run `train.py`. If the `mindrecord_dir` is empty, it will generate [mindrecord](https://www.mindspore.cn/tutorials/en/r1.9/advanced/dataset/record.html) files by `coco_root`(coco dataset), `voc_root`(voc dataset) or `image_dir` and `anno_path`(own dataset). **Note if mindrecord_dir isn't empty, it will use mindrecord_dir instead of raw images.**
...
| Scripts             | [ssd_mobilenetV2_FPNlite](https://gitee.com/mindspore/models/tree/r1.9/research/cv/ssd_mobilenetV2_FPNlite) |[ssd_mobilenetV2_FPNlite](https://gitee.com/mindspore/models/tree/r1.9/research/cv/ssd_mobilenetV2_FPNlite) |
