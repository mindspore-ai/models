...
DEFINE_string(input_type, "", "test or query");
...
int main(int argc, char **argv) {
    ...
    for (size_t i = 0; i < size; ++i) {
        ...
        WriteResult(input0_files[i], outputs, FLAGS_input_type);
    }
    double average = 0.0;
    int inferCount = 0;
    ...
    std::string fileName = "./" + FLAGS_input_type  + "_time_Result" + std::string("/test_perform_static.txt");
