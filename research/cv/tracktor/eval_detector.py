...
from src.dataset import parse_json_annos_from_txt
from src.model_utils.config import config
from src.model_utils.device_adapter import get_device_id
from src.model_utils.moxing_adapter import moxing_wrapper
from src.util import bbox2result_1image
from src.util import coco_eval
from src.util import results2json
...
def fasterrcnn_eval(dataset_path, ckpt_path, anno_path):
    ...
    return coco_eval(config, result_files, eval_types, dataset_coco, single_result=False, plot_detect_result=False)
