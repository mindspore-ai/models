...
def warmup_cosine_annealing_lr(lr, steps_per_epoch, warmup_epochs, max_epoch, T_max, eta_min=0):
    ...
    for i in range(total_steps):
        ...
        if i < warmup_steps:
            ...
            lr = eta_min + (base_lr - eta_min) * (1.0 + math.cos(math.pi * last_epoch / T_max)) / 2
...
def get_lr(args):
    ...
    if args.lr_scheduler == "exponential":
        ...
        lr = warmup_cosine_annealing_lr(
            args.lr, args.steps_per_epoch, args.warmup_epochs, args.max_epoch, args.T_max, args.eta_min
        )
    else:
