...
APP_ERROR AutoAugment::Init(const InitParam &initParam) {
...
APP_ERROR AutoAugment::ConvertImageToTensorBase(const std::string &imgPath,
...
APP_ERROR AutoAugment::Inference(std::vector<TensorBase> &inputs,
...
APP_ERROR AutoAugment::PostProcess(std::vector<TensorBase> &inputs,
...
APP_ERROR AutoAugment::SaveResult(const std::string &imgPath,
...
APP_ERROR AutoAugment::Process(const std::string &imgPath) {
    TensorBase tensorBase;
