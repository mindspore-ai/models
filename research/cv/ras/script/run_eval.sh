...
echo "bash script/eval.sh [device_id] [data_url] [model_path] [pre_model]"
echo "for example: bash script/eval.sh 5 /home/data/Test/ /home/data/results/ /home/data/models/RAS800.ckpt /home/data/resnet50.ckpt"
echo " *****
...
python3 -u eval.py --device_id ${device_id} --data_url ${data_url} --train_url ${train_url} --model_path ${model_path} --pre_model ${pre_model} > output_eval/eval_output.log 2>&1 &
