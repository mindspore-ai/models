...
def create_dataset(dataset_path, do_train, rank, group_size,
                   ...
                   enlarged_image_size=256, final_image_size=224):
    """
    ...
    if do_train:
        trans = [
            C.RandomCropDecodeResize(size=final_image_size, scale=(0.09, 1.0)),
        ]
        if cutout:
        ...
        trans = [
            C.Decode(),
            C.Resize(enlarged_image_size),
            C.CenterCrop(final_image_size),
        ]
