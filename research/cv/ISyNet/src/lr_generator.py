...
def _generate_exp_lr(lr_init, lr_max, lr_decay, total_steps, warmup_steps, decay_steps):
    """
    Applies cosine decay to generate learning rate array.
    ...
    for i in range(total_steps):
        if i < warmup_steps:
            ...
            decay_power = int(i - warmup_steps) // int(decay_steps)
            lr = lr_max * (lr_decay ** decay_power)
        lr_each_step.append(lr)
    return lr_each_step
...
def get_lr(lr_init,
    ...
    if lr_decay_mode == 'steps':
        ...
        lr_each_step = _generate_poly_lr(lr_init, lr_max, total_steps, warmup_steps)
    elif lr_decay_mode == 'cosine':
        lr_each_step = _generate_cosine_lr(lr_init, lr_max, total_steps, warmup_steps)
    elif lr_decay_mode == 'exp':
        lr_each_step = _generate_exp_lr(lr_init, lr_max, lr_decay, total_steps, warmup_steps, decay_steps)
    else:
