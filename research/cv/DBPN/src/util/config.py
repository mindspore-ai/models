...
def get_args(is_gan=False):
    ...
    if is_gan:
        ...
        parser.add_argument('--pretrained_D', default='discirminator.ckpt', help='Sr pretrained base model')
        ...
        parser.add_argument('--load_pretrained_G', type=ast.literal_eval, default=False, help='load generator flag')
        parser.add_argument('--save_folder', default='ckpt/gan', help='Location to save checkpoint models')
        parser.add_argument('--pretrained_dbpn', default='dbpn.ckpt', help='sr pretrained base model')
        parser.add_argument('--Results', default='Results/gan', help='eval image')
    else:
        parser.add_argument('--nEpochs', type=int, default=2000, help='number of epochs to train for')
        parser.add_argument('--batchSize', type=int, default=16, choices=[4, 8, 16], help='training batch size')
