...
VOC_AUG_TRAIN_LST_TXT = os.path.join(data_dir, 'sbd_train_lst.txt')
...
def create_sbd_train_aug_lst_txt():
    """create sbd train list txt"""
    voc_train_data_lst = __get_data_list(VOC_TRAIN_TXT)
    voc_val_data_lst = __get_data_list(VOC_VAL_TXT)
...
if __name__ == '__main__':
    ...
    create_sbd_train_aug_lst_txt()
    print('generating sbd list success.')
