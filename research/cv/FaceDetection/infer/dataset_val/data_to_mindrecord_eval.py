...
dataset_root_list = ["../dataset_val"]

# mindrecord_file_name = "Your_output_path/data.mindrecord"
# Create your own mindrecord_val directory under the project root path
mindrecord_val = "../mindrecord_val/"
mindrecord_file_name = mindrecord_val + "data.mindrecord"
...
def prepare_file_paths():
    ...
    for dataset_root in dataset_root_list:
        ...
        if is_train:
            ...
            # test -> val
            valid_txt = os.path.join(dataset_root, "ImageSets/Main/val.txt")
...
def convert_yolo_data_to_mindrecord():
    ...
    if not os.path.exists(mindrecord_val):
        os.makedirs(mindrecord_val)
