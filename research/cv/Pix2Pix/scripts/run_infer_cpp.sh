...
function infer()
{
    ...
    ../ascend310_infer/out/main --device_type=$device_target --mindir_path=$model --input0_path=./preprocess_Result/00_data --device_id=$device_id --fusion_switch_path=../ascend310_infer/fusion_switch.cfg &> infer.log
