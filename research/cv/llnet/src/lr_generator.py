...
def get_lr(lr_init, lr_decay_rate, num_epoch_per_decay, total_epochs, steps_per_epoch):
    """
    generate learning rate array

    Args:
       lr_init(float): init learning rate
       lr_decay_rate (float): the decay rate for the learning_rate
       num_epoch_per_decay (int):
