...
CUDA_VISIBLE_DEVICES=$DEVICE_ID python ../eval.py --device_target='GPU' --device_id=$DEVICE_ID --drop_remainder=True --dataset_path=$2 --checkpoint=$3 --enable_checkpoint_dir=False > eval.log 2>&1 &
