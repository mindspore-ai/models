...
```shell
python predict.py --ckpt_file [CKPT_PATH] --data_path [TEST_DATA_PATH] > log.txt 2>&1 &  
```

for example:

```bash
python predict.py --ckpt_file ckpt/checkpoint_lenet-1_1875.ckpt --data_path /home/DataSet/MNIST/ > log.txt 2>&1 &  
```
