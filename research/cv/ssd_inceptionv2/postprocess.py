...
parser.add_argument("--anno_file", type=str, required=True, help="annotations files path.")
...
def get_result(result_path, img_id_file_path, anno_file):
    """compute result"""
    anno_json = os.path.join(anno_file, config.instances_set.format(config.val_data_type))
...
if __name__ == '__main__':
    get_result(args.result_path, args.img_path, args.anno_file)
