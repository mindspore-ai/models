...
do
    ...
    if [ $# == 5 ]
    then
    python train.py --data_url $PATH1 --mindrecord_url $PATH2 --train_url $PATH3 --run_platform Ascend --lr 0.09 --epoch_size 1000 --dataset $2 --distribute True --device_num 8 &> log &
    else
    python train.py --data_url $PATH1 --mindrecord_url $PATH2 --train_url $PATH3 --run_platform Ascend --lr 0.09 --epoch_size 1000 --dataset $2 --pre_trained $PATH4 --distribute True --device_num 8 &> log &
    fi
    cd ..
done
