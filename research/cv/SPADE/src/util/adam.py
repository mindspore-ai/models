...
# Part of the file was copied from project OpenHarmony/third_party_mindspore https://gitee.com/openharmony/third_party_mindspore
""" adam """
...
def _check_param_value(beta1, beta2, eps, prim_name):
    ...
    validator.check_float_range(beta1, 0.0, 1.0, validator.INC_BOTH, "beta1", prim_name)
    validator.check_float_range(beta2, 0.0, 1.0, validator.INC_BOTH, "beta2", prim_name)
