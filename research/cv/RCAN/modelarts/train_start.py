...
def _parse_args():
    """parse the arguments"""
    parser = argparse.ArgumentParser(description='train and export rcan on modelarts')
    # train output path
    ...
    parser.add_argument("--export_file_name", type=str, default="rcan", help="output file name.")
