...
- 分布式训练需要提前创建JSON格式的HCCL配置文件。具体操作，参见：<https://gitee.com/mindspore/models/tree/r1.5/utils/hccl_tools>
...
| 脚本                  |[RCAN](https://gitee.com/mindspore/models/tree/r1.5/research/cv/RCAN) |                   |
