...
APP_ERROR WdsrSuperresolution::DeInit() {
    model_->DeInit();
    MxBase::DeviceManager::GetInstance()->DestroyDevices();
    return APP_ERR_OK;
}

APP_ERROR WdsrSuperresolution::PaddingImage(cv::Mat *imageSrc, cv::Mat *imageDst, const uint32_t &targetLength) {
...
APP_ERROR WdsrSuperresolution::ReadImage(const std::string &imgPath, cv::Mat *imageMat) {
...
APP_ERROR WdsrSuperresolution::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase *tensorBase) {
...
APP_ERROR WdsrSuperresolution::Inference(std::vector<MxBase::TensorBase> *inputs,
...
APP_ERROR WdsrSuperresolution::PostProcess(std::vector<MxBase::TensorBase> *inputs, cv::Mat *imageMat) {
...
APP_ERROR WdsrSuperresolution::Process(const std::string &imgPath) {
    cv::Mat imageMat;
