...
"""Evaluation for retinanetNASFPN"""
...
from src.retinanet_nasfpn import retinanetNASFPN, retinanetInferWithDecoder
from src.dataset import create_retinanet_dataset, data_to_mindrecord_byte_image
...
def retinanet_nasfpn_eval():
    ...
    net = retinanetNASFPN(config, is_training=False)
