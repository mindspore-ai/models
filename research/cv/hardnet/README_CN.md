...
| 脚本                  | [hardnet脚本](https://gitee.com/mindspore/models/tree/r1.9/research/cv/hardnet) | [hardnet脚本](https://gitee.com/mindspore/models/tree/r1.9/research/cv/hardnet) |
...
如果您需要使用此训练模型在Ascend 910上进行推理，可参考此[链接](https://www.mindspore.cn/tutorials/experts/zh-CN/r1.9/infer/inference.html)。下面是操作步骤示例：
...
如果您需要使用此训练模型在GPU上进行推理，可参考此[链接](https://www.mindspore.cn/tutorials/experts/zh-CN/r1.9/infer/inference.html)。下面是操作步骤示例：
