...
APP_ERROR hardnetClassifyOpencv::Init(const InitParam &initParam) {
...
APP_ERROR hardnetClassifyOpencv::DeInit() {
    dvppWrapper_->DeInit();
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR hardnetClassifyOpencv::ConvertImageToTensorBase(const std::string &imgPath,
    ...
    cv::Rect m_select = cv::Rect(16, 16, 224, 224);
    imageMat = imageMat(m_select);
...
APP_ERROR hardnetClassifyOpencv::Inference(std::vector<TensorBase> &inputs,
...
APP_ERROR hardnetClassifyOpencv::PostProcess(std::vector<TensorBase> &inputs,
...
APP_ERROR hardnetClassifyOpencv::SaveResult(const std::string &imgPath,
...
APP_ERROR hardnetClassifyOpencv::Process(const std::string &imgPath) {
    TensorBase tensorBase;
