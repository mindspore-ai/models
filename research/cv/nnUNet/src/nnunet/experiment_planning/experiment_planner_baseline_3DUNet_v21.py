...
"""experiment planner 3D"""

from copy import deepcopy

import numpy as np
from src.nnunet.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner

from src.nnunet.experiment_planning.common_utils import get_pool_and_conv_props
from src.nnunet.network_architecture.generic_UNet import Generic_UNet
from src.nnunet.paths import join
...
class ExperimentPlanner3D_v21(ExperimentPlanner):
    ...
    def get_target_spacing(self):
        ...
        (for example ACDC with (10, 1.5, 1.5)). These datasets still have examples with a spacing of 5 or 6 mm in the
        low resolution axis. Choosing the median here will result in bad interpolation artifacts that can substantially
