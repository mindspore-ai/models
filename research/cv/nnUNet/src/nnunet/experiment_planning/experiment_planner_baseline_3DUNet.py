...
"""expriment planner baseline 3D UNet"""
...
from batchgenerators.utilities.file_and_folder_operations import subfiles, subdirs, \
    isfile, join, load_pickle, pickle, os, maybe_mkdir_p
...
from src.nnunet.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from src.nnunet.experiment_planning.utils import create_lists_from_splitted_dataset
from src.nnunet.network_architecture.generic_UNet import Generic_UNet
from src.nnunet.paths import default_data_identifier, nnUNet_cropped_data, nnUNet_raw_data, preprocessing_output_dir
from src.nnunet.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner():
    ...
    def plan_experiment(self):
        ...
        if more:
            ...
            while num_voxels > self.how_much_of_a_patient_must_the_network_see_at_stage0 \
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", action="store_true", help="set this if you actually want to run the preprocessing.")
    ...
    for t in tasks:
        try:
            ...
            lists, modalities_task = create_lists_from_splitted_dataset(splitted_4d_output_dir_task)
            ...
            print("This should be a general exception,but pylint not allowed")
