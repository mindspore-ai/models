...
from src.nnunet.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
class Evaluator:
    ...
    def construct_labels(self):
        ...
        self.labels = list(map(self.g, labels))
