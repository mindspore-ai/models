...
def create_visualization_statistical_result(prediction_file_path,
    ...
    :return:
    """
    writer = open(os.path.join(result_store_path, jsonfile_name), 'w')
    table_dict = {}
...
if __name__ == '__main__':
    try:
        ...
        # annotation .json files path, "val_label.json"
