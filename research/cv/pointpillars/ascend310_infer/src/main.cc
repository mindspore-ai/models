...
DEFINE_string(mindir_path, "/home/stu/yy/pointpillars/pillars_160.mindir", "mindir path");
DEFINE_string(input0_path, "/home/stu/yy/pointpillars/process_Result/voxels_data", "input data0");
DEFINE_string(input1_path, "/home/stu/yy/pointpillars/process_Result/num_points_data", "input data1");
DEFINE_string(input2_path, "/home/stu/yy/pointpillars/process_Result/coors_data", "input data2");
...
int main(int argc, char **argv) {
  ...
  for (auto tensor : model_inputs) {
    std::cout << "--> input data name:" << tensor.Name() << ",shape:" << tensor.DataSize() << std::endl;
  }
