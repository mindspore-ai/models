...
- GPU处理器环境运行
    ...
    具体操作，参见[hccl_tools](https://gitee.com/mindspore/models/tree/r1.8/utils/hccl_tools) 中的说明。
...
| 脚本          | [链接](https://gitee.com/mindspore/models/tree/r1.8/research/cv/3dcnn) | [链接](https://gitee.com/mindspore/models/tree/r1.8/research/cv/3dcnn) |
