...
def add_modelarts_parameters(parser):
    """ add modelarts parameters """
    ...
    parser.add_argument("--obs_result_dir", type=str, default="s3://stgan/output/")  # modelarts -> obs
...
def get_args(phase):
    ...
    # modelarts parameters
    parser = add_modelarts_parameters(parser)
