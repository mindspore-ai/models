...
from src.mmpose.post_transforms import (affine_transform, fliplr_joints,
...
class ToTensor:
    ...
    def __call__(self, results):
        results['img'] = Tensor(results['img'])
        return results
...
class NormalizeTensor:
    ...
    def __init__(self, mean, std):
        self.mean = [el * 255. for el in mean]
        self.std = [el * 255. for el in std]
