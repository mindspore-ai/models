...
# ============================================================================
"""Implementing a Top-Down dataset"""
import copy
...
from src.mmpose.top_down_eval import (keypoint_auc, keypoint_epe,
                                      keypoint_nme,
                                      keypoint_pck_accuracy)
from src.mmpose.dataset_info import DatasetInfo
from src.mmpose.shared_transforms import registry_dict
    ...
    def __init__(self, transforms):
        ...
        for transform in transforms:
            if isinstance(transform, dict):
                ...
                transform = registry_dict[transform_type](**transform)
...
class Kpt2dSviewRgbImgTopDownDataset():
    ...
    def __getitem__(self, idx):
        ...
        outputs = self.pipeline(results)
        if self.test_mode:
            item = outputs['img'], outputs['img_metas']
        else:
            item = outputs['img'], outputs['target'], np.squeeze(outputs['target_weight'])
        return item
