...
if [ $# != 3 ] && [ $# != 4 ]
then 
    echo "Usage: bash train_distribute_PCB_market.sh [RANK_SIZE] [DATASET_PATH] [CONFIG_PATH] [PRETRAINED_CKPT_PATH](optional)"
    exit 1
fi
...
LOG_SAVE_PATH=${script_dir_path}/output/log/PCB/market/train/
