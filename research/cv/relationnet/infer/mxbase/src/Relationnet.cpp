...
APP_ERROR Relationnet::Init(const InitParam &initParam) {
...
APP_ERROR Relationnet::ReadTensorFromFile(const std::string &file, uint32_t *data, uint32_t size) {
...
APP_ERROR Relationnet::ReadInputTensor(const std::string &fileName, std::vector<MxBase::TensorBase> *inputs) {
...
APP_ERROR Relationnet::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR  Relationnet::WriteResult(const std::string& imageFile, std::vector<MxBase::TensorBase> &outputs) {
...
APP_ERROR Relationnet::Process(const std::string &inferPath, const std::string &fileName) {
