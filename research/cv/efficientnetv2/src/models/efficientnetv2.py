...
#
# model = effnetv2_s(args)
# data = Tensor(np.ones([1, 3, 224, 224]), dtype.float32)
# from mindspore import context
# context.set_context(mode=1)
# from mindspore import load_checkpoint, load_param_into_net
# ckpt = load_checkpoint("efficientnets_imagenet1k.ckpt")
# load_param_into_net(model, ckpt)
# print(model(data)[0][:10])
