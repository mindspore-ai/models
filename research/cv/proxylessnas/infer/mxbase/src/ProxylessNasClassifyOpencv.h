...
#ifndef MXBASE_PROXYLESSNASCLASSIFYOPENCV_H
#define MXBASE_PROXYLESSNASCLASSIFYOPENCV_H
#include <string>
#include <vector>
#include <memory>
...
class ProxylessNasClassifyOpencv {
 public:
...
#endif  // MXBASE_PROXYLESSNASCLASSIFYOPENCV_H
