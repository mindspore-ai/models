...
- Distributed mode
    ...
    The input variables are device numbers, epoch size, mindrecord directory path, dataset directory path, train TXT file path and [hccl json configuration file](https://gitee.com/mindspore/models/tree/r2.0/utils/hccl_tools). **It is better to use absolute path.**
...
To eval, run `eval.py` with the dataset `image_dir`, `anno_path`(eval txt), `mindrecord_dir` and `ckpt_path`. `ckpt_path` is the path of [checkpoint](https://www.mindspore.cn/tutorials/en/master/beginner/save_load.html) file.
...
| Parameters (M)             | 189                                                         |
| Scripts                    | [yolov3_resnet18 script](https://gitee.com/mindspore/models/tree/r2.0/research/cv/yolov3_resnet18) | [yolov3_resnet18 script](https://gitee.com/mindspore/models/tree/r2.0/research/cv/yolov3_resnet18) |
