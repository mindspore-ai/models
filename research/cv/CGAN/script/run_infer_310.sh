...
function infer()
{
    ...
    ../ascend310_infer/out/main --mindir_path=$model --input0_path=./preprocess_Result/latent_code --input1_path=./preprocess_Result/label --device_id=$device_id &> infer.log
