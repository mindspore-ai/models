...
| outputs                    | probability                                                 |
| Loss                       | 1.5931969                                                   |
| Speed                      | 331 ms/step（8pcs）                     |
| Total time                 | 241 mins                                                  |
| Parameters (M)             | 27M                                                     |
| Checkpoint for Fine tuning | 270M (.ckpt file)                                         |
| Scripts                    | [Link](https://gitee.com/mindspore/mindspore/tree/r1.2/model_zoo/research/cv/SE-Net) |
