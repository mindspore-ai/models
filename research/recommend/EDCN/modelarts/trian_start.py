...
def run_train():
    '''train function'''
    parser = argparse.ArgumentParser(description='edcn')
    parser.add_argument('--data_url', type=str, default='')
    parser.add_argument('--enable_modelarts', type=bool, default=True)
    ...
    model.train(args_opt.train_epochs, ds_train, callbacks=callback_list)
...
def export_air():
    ...
    from_path = os.path.join('./', config.file_name + '.' + config.file_format.lower())
    mox.file.copy(from_path, config.ckpt_path+"/../edcn.air")
