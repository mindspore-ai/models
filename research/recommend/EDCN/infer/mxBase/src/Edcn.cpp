...
APP_ERROR EDCN::Init(const InitParam &initParam) {
...
APP_ERROR EDCN::VectorToTensorBase(const std::vector<std::vector<dtype>> &input, uint32_t inputId
...
APP_ERROR EDCN::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR EDCN::PostProcess(std::vector<float> &probs, const std::vector<MxBase::TensorBase> &inputs) {
    size_t index = 0;
...
APP_ERROR EDCN::PrintInputInfo(std::vector<MxBase::TensorBase> inputs) {
...
APP_ERROR EDCN::Process(const std::vector<std::vector<int>> &ids, const std::vector<std::vector<float>> &wts,
