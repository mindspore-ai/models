...
class SelfAttention(nn.Cell):
    ...
    def __init__(self,
        ...
        self.attention = MultiheadAttention(
            enable_dynamic_mode=enable_dynamic_mode,
...
class TransformerEncoder(nn.Cell):
    ...
    def __init__(self,
        ...
        for _ in range(num_hidden_layers):
            layer = EncoderCell(enable_dynamic_mode=enable_dynamic_mode,
                                batch_size=batch_size,
                                hidden_size=hidden_size,
                                num_attention_heads=num_attention_heads,
...
class TransformerDecoder(nn.Cell):
    ...
    def __init__(self,
        ...
        layers = []
        for _ in range(num_hidden_layers):
            layer = DecoderCell(enable_dynamic_mode=enable_dynamic_mode,
                                batch_size=batch_size,
                                hidden_size=hidden_size,
                                num_attention_heads=num_attention_heads,
                                intermediate_size=intermediate_size,
...
class CreateAttentionMaskFromInputMask(nn.Cell):
    ...
    """
    def __init__(self, enable_dynamic_mode):
...
class TransformerDecoderStep(nn.Cell):
    ...
    def __init__(self,
        ...
        self._create_attention_mask_from_input_mask = CreateAttentionMaskFromInputMask(enable_dynamic_mode)
        self.expand = ops.ExpandDims()
        self.multiply = ops.Mul()
...
class TransformerModel(nn.Cell):
    ...
    def __init__(self,
        ...
        self.enable_dynamic_mode = config.enable_dynamic_mode
        ...
        self.tfm_embedding_lookup = EmbeddingLookup(
            enable_dynamic_mode=self.enable_dynamic_mode,
        ...
        if is_training:
            ...
            self.tfm_decoder = BeamSearchDecoder(
                ...
                enable_dynamic_mode=config.enable_dynamic_mode,
            ...
            self.tile_beam = TileBeam(beam_width=self.beam_width, enable_dynamic_mode=self.enable_dynamic_mode)
        ...
        self._create_attention_mask_from_input_mask = CreateAttentionMaskFromInputMask(self.enable_dynamic_mode)
