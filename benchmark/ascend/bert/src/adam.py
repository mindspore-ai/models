...
def _check_param_value(beta1, beta2, eps, prim_name):
    ...
    assert isinstance(beta1, float) and 0 <= beta1 <= 1.0, "beta1 should be float and between 0 and 1"
    assert isinstance(beta2, float) and 0 <= beta2 <= 1.0, "beta2 should be float and between 0 and 1"
