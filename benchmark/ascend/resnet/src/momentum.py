...
class Momentum(Optimizer):
    ...
    Raises:
        AssertionError: If the momentum is less than 0.0.
        AssertionError: If the momentum is not a float or use_nesterov is not a bool.
    ...
    def __init__(self, params, learning_rate, momentum, weight_decay=0.0, loss_scale=1.0, use_nesterov=False):
        ...
        assert isinstance(momentum, float) and momentum >= 0.0, "momentum should be equal or bigger than 0"
