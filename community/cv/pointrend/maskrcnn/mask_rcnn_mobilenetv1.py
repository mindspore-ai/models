...
from maskrcnn.maskrcnn_mobilenetv1.resnet50 import ResNetFea, ResidualBlockUsing
from maskrcnn.maskrcnn_mobilenetv1.bbox_assign_sample_stage2 import BboxAssignSampleForRcnn
from maskrcnn.maskrcnn_mobilenetv1.fpn_neck import FeatPyramidNeck
from maskrcnn.maskrcnn_mobilenetv1.proposal_generator import Proposal
from maskrcnn.maskrcnn_mobilenetv1.rcnn_cls import RcnnCls
from maskrcnn.maskrcnn_mobilenetv1.rcnn_mask import RcnnMask
from maskrcnn.maskrcnn_mobilenetv1.rpn import RPN
from maskrcnn.maskrcnn_mobilenetv1.roi_align import SingleRoIExtractor
from maskrcnn.maskrcnn_mobilenetv1.anchor_generator import AnchorGenerator
    ...
    def construct(self, img_data, img_metas, gt_bboxes, gt_labels, gt_valids, gt_masks):
        ...
        if self.training:
            for i in range(self.train_batch_size):
                ...
                bboxes, deltas, labels, mask, pos_bboxes, pos_mask_fb, pos_labels, pos_mask, _ = \
