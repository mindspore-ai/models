...
# https://gitee.com/mindspore/models/blob/master/research/cv/PSPNet/src/utils/aux_loss.py
...
class SoftmaxCrossEntropyLoss(nn.Cell):
    ...
    def construct(self, logits, labels):
        ...
        labels_int = labels_int.reshape((-1,))
        logits_ = self.transpose(logits, (0, 2, 3, 1))
        logits_ = logits_.reshape((-1, self.num_cls))
