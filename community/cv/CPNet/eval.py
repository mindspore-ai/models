...
# This file was copied from project [MindSpore][PSPNet]
# https://gitee.com/mindspore/models/blob/master/research/cv/PSPNet/eval.py
...
def cal_acc(data_list, pred_folder, classes, names=None):
    ...
    for i in range(classes):
        logger.info('Class_{} result: iou/accuracy {:.4f}/{:.4f}.'.format(i, iou_class[i], accuracy_class[i])) #names[i]
