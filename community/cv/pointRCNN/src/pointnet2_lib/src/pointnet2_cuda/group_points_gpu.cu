...
void group_points_grad_kernel_launcher_fast(int b, int c, int n, int npoints,
  ...
  group_points_grad_kernel_fast<<<blocks, threads, 0, stream>>>(
...
__global__ void group_points_kernel_fast(int b, int c, int n, int npoints,
                                         int nsample,
...
void group_points_kernel_launcher_fast(int b, int c, int n, int npoints,
  ...
  group_points_kernel_fast<<<blocks, threads, 0, stream>>>(
